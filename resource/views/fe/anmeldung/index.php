...
$cru = [
    ...
    ['topic'=>getUserLang('login.anmeldung')]
];
$template->assign('breadcrumb',Breadcrumb::generate($cru));
$template->assign('login.anmeldung',getUserLang('login.anmeldung'));
...
$template->assign('login.kennwort_wiederherstellen',getUserLang('login.kennwort_wiederherstellen'));
echo $template->show();